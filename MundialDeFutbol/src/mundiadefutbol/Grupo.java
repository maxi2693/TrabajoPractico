...
public class Grupo extends EtapaMundial {
    ...
    public List<Equipo> getEquiposQueAvanzan() {
        ...
        for (Partido partido : super.getPartidos()) {
            if (getPuntos(partido.getLocal()) > getPuntos(equipoAux));
            equipoAux = partido.getLocal();
            
            if (getPuntos(partido.getVisitante()) > getPuntos(equipoAux)) {
                equipoAux = partido.getVisitante();
            }
